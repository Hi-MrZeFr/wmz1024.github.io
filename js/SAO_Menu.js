window.document.oncontextmenu = function(event) {
  ...
  function Mirror() {
    ...
    if (hostname === 'blog.wmza.cn') {
      url = "https://wmz1024.gitee.io" + pathname;
      window.alert("即将前往Wmz1024的分店");
      window.location.href = url;
    }
    else if(hostname === 'wmz1024.gitee.io') {
      url = "https://blog.wmza.cn" + pathname;
      window.alert("即将前往Wmz1024的主店");
      window.location.href = url;
    }
    else {
      window.alert("主人，本地调试不需要跳转哦！");
    }
  }
  //评论窗口跳转
  function ToComment(){
